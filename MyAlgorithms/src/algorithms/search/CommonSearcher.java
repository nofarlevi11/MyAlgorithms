...
/**
 * This abstract class define the common features of the problems(/games) which
...
public abstract class CommonSearcher<T> implements Seracher<T> {
	...
	/**
	 * This method used to save the solution of the problem, into a list, after
	 * solving the problem
	 * 
	 * @param goalState
	 *            is the last and finite step, and this function will find the
	 *            steps of the solution by saving to a list, every CAMEFROM
	 *            state, till the last one - the Start State
	 * 
	 * @param goalState
	 *            the goal state
	 * @return the solution
